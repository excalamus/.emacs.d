...
\(fn\)"
  ...
  (cond ((eql arg 1)
         (cond ((eq xc/device 'windows)
                (setq proc (start-process "cmd" nil "cmd.exe" "/C" "start" "C:/emacs-28.1/bin/runemacs.exe")))
               ((eq xc/device 'gnu/linux)
        ...
        ((eql arg 4)
         (cond ((eq xc/device 'windows)
                (setq proc (start-process "cmd" nil "cmd.exe" "/C" "start" "C:/emacs-28.1/bin/runemacs.exe" "-q")))
               ((eq xc/device 'gnu/linux)
